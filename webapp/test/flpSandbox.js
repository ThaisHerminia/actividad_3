		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Creación proyecto Fiori",
									"targetURL": "#tareathaisactividad3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tareathaisactividad3-display": {
								"semanticObject": "tareathaisactividad3",
								"action": "display",
								"description": "Creación proyecto Fiori",
								"title": "Creación proyecto Fiori",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tareathais.actividad3",
									"url": sap.ui.require.toUrl("tareathais/actividad3")
								}
							}
						}
					}
